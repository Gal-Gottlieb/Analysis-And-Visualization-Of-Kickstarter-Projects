...
-- 6) Verifying whether any column's NULL values exist in the database
...
-- 7) Looking for outliers in the columns Goal, Pledged, and Backers

select *
from kickstarter_project
where goal<=0 or Pledged<0 or Backers<0;

-- 8) Deleting outliers where Goal is equal to zero

delete from kickstarter_project
where goal=0;

-- 9) Checking for duplication of categories and subcategories

select distinct Category,Subcategory
from kickstarter_project
order by Category, Subcategory;

-- 10) Checking that there are no duplicate countries

select distinct(Country)
from kickstarter_project
order by Country;

-- 11) Making sure the primary key values (ID) do not repeat
...
-- 12) Adding constraints to the table's columns
...
-- A look at the Max launched date in 2018
...
-- A look at the Min launched date in 2009
...
-- 3) Checking the hours project distribution in different countries
...
/* 4) Annual goal completion by category and project 
Where project's goal greater than 1,000
Table used in Exhibits 1 and 3
*/
...
/* 5) Top 20,000 projects in terms of goal completion rate
Where project's goal greater than 1,000
*/
...
/* 6) Top 20 projects in terms of goal completion rate
Where project's goal greater than 1,000
*/
...
-- 7) Median vs. AVG of pledged and goal of projects 
...
-- 8) -- Statistics by year of launch, category, and pledge Between 2010 and 2017
...
-- 9) Statistics by month of launched, category and pledged Between 2010 and 2017
...
/* 10) Stats on pledged funds by country and category Between 2010 and 2017
Where project's goal greater than 1,000
*/
...
/* 11) Stats on pledged funds by  category and sub category
Where project's goal greater than 1,000
*/
...
-- 12) Duration of campaigns by country, by category, by subcategory, and by successful and unsuccessful projects
...
-- 13) The number of projects by country
...
-- 14) Success of project in USA by project's launch hour
...
/* 
15) Project's success by Category, subcategory, country and year between 2010 and 2017
Where project's goal greater than 1,000
Table used in Exhibit 2
*/
...
-- 16) Duration in days, Median Goal, Median Pledge and Average Number of Backers by year and category and by success
...
/* 17) Duration in days, Median Project's Goal, Median Pledge and average number of backers 
...
-- 18) Duration in days, Median Project's Goal, Median Pledge and average number of backers by state and category and by success
...
/* 28) In addition to categories and subcategories by year and countries, the following metrics are used:
